...
// ID: rb868x 9994 Jun 24 13:58 Assignment2_BUG.java
//
...
public class Assignment2_BUG {
	public static void main(String[] args) {
		new Assignment2_BUG();
	}

	// This will act as our program switchboard
	public Assignment2_BUG() {
	...
	private void displayFlowers(Flower_V2 flowerPack[]) {
		...
		case 2:
			...
			if (flowerPack[i].getFlowerScent())
				...
				// NOTE HERE IS A DESIGN BUG: THIS SET OF CONDITIONAL STATEMENTS RETURNS
				// IMPROPER RESULTS BY NESTING THE LOGIC IN 'if (searchFlowerName)'
				if (searchFlowerName) {
				...
				}	// This paren closes the conditional 'if (searchFlowerName)',
					// thus nesting the if/else conditional

				/*	// This set of conditionals correctly impliments the desired logic
				 * if (searchFlowerName) {
                                 *      if (flowerPack[i].getFlowerName().equals(flowerObject[k].getFlowerName())) {
                                 *              found = true;
                                 *              break;
